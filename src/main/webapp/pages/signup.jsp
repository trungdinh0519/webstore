...
<html>
	<head>
		<title><fmt:message key="label.signup" />
		</title>
		...
		<script language="javascript">
			function getProvince(country){
				...
				form.action="Registry.do?method=registry&&c_code="+country;
	...
	<body>
		<div id="heading">
			<h3><fmt:message key="label.signup" /></h3>
		</div>
		<html:form action="/pages/user?method=signup" method="post"
		...
		<script type="text/javascript">
			Form.focusFirtElement($('userForm'));
		</script>
